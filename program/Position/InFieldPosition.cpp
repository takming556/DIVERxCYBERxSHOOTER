...
Position InFieldPosition::GET_DRAW_POSITION(double given_infieldpos_x, double given_infieldpos_y) {
	double distance_from_center_y = Field::DRAW_POSITION_Y - given_infieldpos_y;
	double draw_pos_x = given_infieldpos_x + Field::DRAW_POSITION_X + DRAW_POS_OFFSET_X;
	double draw_pos_y = given_infieldpos_y + Field::DRAW_POSITION_Y + DRAW_POS_OFFSET_Y + distance_from_center_y * 2;
	return Position(draw_pos_x, draw_pos_y);
}
