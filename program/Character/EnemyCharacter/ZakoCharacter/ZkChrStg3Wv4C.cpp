...
const double ZkChrStg3Wv4C::PORTAL_INIT_ARG = 0.0 * pi;	// ÔøΩ÷êÔøΩÔøΩÔøΩ
...
const unsigned int ZkChrStg3Wv4C::LASER_NOTIFY_COLOR = (GetColor(100, 100, 100));	// ÔøΩ\ÔøΩÔøΩÔøΩÔøΩÔøΩÃêFÔøΩwÔøΩÔøΩ
...
void ZkChrStg3Wv4C::update() {
	...
	if (MODE == Stg3WAVE4CMode::ENTER) {
		...
		if (elapsed_time > 1000){
			if (laser_notify_count == 0) {														// ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ ÇÔøΩ1ÔøΩÔøΩÔøΩ⁄ÇÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩLÔøΩÔøΩÔøΩÔøΩÔøΩÃçÔøΩÔøΩWÔøΩÔøΩÔøΩÊìæ
				...
				for (int i = 0; i < 6; ++i) {
					...
					double laser_arg = atan2(laser_delta_y_mychr, laser_delta_x_mychr);			// ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÁé©ÔøΩ@ÔøΩ÷åÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩpÔøΩx

					double laser_notify_end_x = portal_poses_x.at(i) + cos(laser_arg) * LASER_LENGTH;	// InFieldPositionÔøΩ≈èIÔøΩ[ÔøΩÔøΩÔøΩWÔøΩÃéZÔøΩo
					...
					draw_position_begin = position_begin.get_draw_position();			// InFieldPostionÔøΩÔøΩÔøΩÔøΩPositionÔøΩ…ïœäÔøΩ
			...
			for (int i = 0; i < 6; ++i) {
				DxLib::DrawLine(	//ÔøΩ@ÔøΩ\ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ`ÔøΩÔøΩ
		...
		if (elapsed_time > 3000) {
			for (auto& portal_id : PORTAL_IDS) {	// ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ
				(*Field::ENEMY_BULLETS).erase(portal_id);
			}
			for (auto& laser_id : LASER_IDS) {	// ÔøΩÔøΩÔøΩ[ÔøΩUÔøΩ[ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ
			...
			PORTAL_IDS.clear();
			LASER_IDS.clear();				// vectorëSïîclear()ÇµÇƒÇ›ÇΩÇØÇ«ÇæÇﬂÇæÇ¡ÇΩ
