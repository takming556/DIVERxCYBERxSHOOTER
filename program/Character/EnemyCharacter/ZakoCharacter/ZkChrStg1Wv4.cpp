...
const unsigned int ZkChrStg1Wv4::TICKS = 3;
const unsigned int ZkChrStg1Wv4::TICK_INTERVAL = 125;
const unsigned int ZkChrStg1Wv4::SHOT_INTERVAL = 2000;
const unsigned int ZkChrStg1Wv4::INITIAL_HP = 5;
const unsigned int ZkChrStg1Wv4::COLLIDANT_SIZE = 20;



ZkChrStg1Wv4::ZkChrStg1Wv4(int init_pos_x, int init_pos_y) :
