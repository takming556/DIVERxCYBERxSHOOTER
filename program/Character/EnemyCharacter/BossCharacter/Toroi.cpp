...
const int Toroi::SP1_THINKING_TIME_LENGTH = 5000;						// [É~Éäïb]
...
const unsigned int Toroi::SP1_TRICK_NOZZLE_RADIUS = 120;				// SP1ÇÃTrickÇÃíeÇÃî≠éÀì_ÇÃîºåa
...
const unsigned int Toroi::SP1_TRICK_SHOT_INTERVAL = 300;				// SP1ÇÃTrickÇÃî≠éÀä‘äu[É~Éäïb]
...
const unsigned int Toroi::SP1_TREAT_DURATION = 100000;					// [É~Éäïb]
const unsigned int Toroi::SP1_TREAT_THROW_AMOUNT = 64;
const unsigned int Toroi::SP1_TREAT_THROW_INTERVAL = 1500;				// [É~Éäïb]
