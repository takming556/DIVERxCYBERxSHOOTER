...
void FontHandles::LOAD_ALL_FONT() {
	...
	NARRATIVE_POP_TEXT = DxLib::CreateFontToHandle(FONTS.at(2).first.c_str(), 24, 1, DX_FONTTYPE_ANTIALIASING_8X8, DX_CHARSET_UTF8);
	NARRATIVE_POP_TEXT_NOSTALGIC = DxLib::CreateFontToHandle(FONTS.at(3).first.c_str(), 24, -1, DX_FONTTYPE_ANTIALIASING_8X8, DX_CHARSET_UTF8);
	...
	SONG_NAME_TEXT = DxLib::CreateFontToHandle(FONTS.at(5).first.c_str(), 32, -1, DX_FONTTYPE_ANTIALIASING_8X8, DX_CHARSET_UTF8);
	SP_NAME_TEXT = DxLib::CreateFontToHandle(FONTS.at(6).first.c_str(), 32, -1, DX_FONTTYPE_ANTIALIASING_8X8, DX_CHARSET_UTF8);
